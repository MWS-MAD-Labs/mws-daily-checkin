...
export const HUB_APPLICATIONS = [
    ...
    // ── Teaching & Students ──────────────────────────────────────────────
    {
        ...
        // Three landing routes depending on access level - preserves what the
        // previous /support-hub card did, using the util that already exists.
        href: "/mtss/teacher", resolveHref: (user) => getDefaultMtssRoute(user) || "/select-role", external: false,
        status: "active", access: "granted", discoverable: true,
    },
    {
        ...
        href: "/select-role", external: false,
        status: "active", access: "granted", discoverable: true,
    },
    {
